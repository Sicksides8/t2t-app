...
export const PENPOT_FRAMES: Record<string, PenpotFrameMeta> = {
  ...
  '05_Identificacion': {
    ...
    body: 'La IA tampoco lo resuelve, necesita que tú entrenes.',
    orbVariant: 'default',
  },
  '06_Tension': {
    id: '06_Tension',
    penId: '06',
    title: 'Está en cómo pensás y trabajás con otros.',
    body: 'Eso se entrena y te hace mejor.',
    orbVariant: 'default',
  },
  '07_Diferencial': {
    id: '07_Diferencial',
    ...
    body: 'Un sistema que se adapta a tu nivel, ritmo y objetivos profesionales.',
    orbVariant: 'default',
  },
  '08_Transformacion': {
    ...
    body: 'Lo que entrenás todos los días termina definiendo quién te conviertes.',
    orbVariant: 'default',
  },
  '09_Accion': {
    id: '09_Accion',
  ...
  '32_Resultado_Radar': {
    ...
    penId: '32',
    title: 'Tu radar',
    body: 'La fuerza de tu cerebro actual · Resultado de tu diagnóstico',
    orbVariant: 'diagnostic',
  ...
  '33_Recibir_Email': {
    ...
    body: 'Te enviamos tu radar completo y un resumen de tus 11 habilidades.',
    orbVariant: 'diagnostic',
    illustrationKey: 'verify',
  },
  '34_Mapa_Cerebral': {
